...
def get_gpuDrive_vars(training_config, 
    ...
    if moving_veh_masks is None:
        moving_veh_masks = get_mov_veh_masks(env_config, train_loader, max_agents, device)
    ...
    return (env_config, train_loader, env, moving_veh_masks, sim_agent)



def get_mov_veh_masks(env_config: EnvConfig, 
                      train_loader: SceneDataLoader, 
                      max_agents: int,
                      device: str, 
                        ) -> dict:
